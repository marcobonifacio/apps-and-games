...
# ╔═╡ 49210662-7a78-11ef-19b7-570c8ffca290
using FinanceModels

# ╔═╡ 89c31920-81fc-474e-91bf-aa6d57edd15b
begin
	q_rate = ZCBYield([0.01,0.02,0.03]);
	q_spread = ZCBYield([0.01,0.01,0.01]);
end

# ╔═╡ 76ae1697-78c2-4959-8ef3-f265593e334f
begin
	model_rate = fit(Spline.Linear(),q_rate,Fit.Bootstrap());        
	model_spread = fit(Spline.Linear(),q_spread,Fit.Bootstrap());
end

# ╔═╡ 56a471dd-0c49-4e9f-bd24-87b216a87652
zero(model_spread + model_rate,1)

# ╔═╡ aea8488d-46fd-4675-a046-ac055b912b4c
discount(model_spread + model_rate,0,3)

# ╔═╡ 18ed632f-7076-4570-80a5-0a33ffd37cc2
present_value(model_rate,Cashflow(10,3))

# ╔═╡ b9bdf88d-e934-4f6c-96b2-08d36c24a0cf
b = Bond.Fixed(0.04,Periodic(2),3)

# ╔═╡ e9f987e3-f268-4213-b715-2317675d5196
...
manifest_format = "2.0"
project_hash = "51faf54d67a2b54645ea949a96a0c1ab9073d917"
...
git-tree-sha1 = "368f746ca67e3607d78e461eaf60ac81e84901b3"
...
[[deps.JMcDM]]
deps = ["Requires"]
git-tree-sha1 = "899ce92e13e5a7139a7e571659b827463418f313"
...
git-tree-sha1 = "f81be1b856b4837a10a5161f988db5bbb9af0ce6"
